...
const envSchema = z.object({
  ...
  // Legacy Configuration (kept for backwards compatibility during migration)
  DATABASE_URL: z.string().optional().default("file:dev.db"),
  BETTER_AUTH_SECRET: z.string().optional().default("legacy-not-used"),

  // Used for Expo client access
